...
## Dasar Teori
Multi Linked List merupakan sebuah arsitektur struktur data yang menggabungkan beberapa list terpisah menjadi satu kesatuan yang saling terintegrasi. Karakteristik unik dari sistem ini adalah setiap elemen memiliki kemampuan untuk menciptakan jalur cabang sendiri, yang secara struktural dibagi menjadi dua tingkatan utama, yakni elemen Induk (Parent) sebagai penyimpan data utama dan elemen Anak (Child) sebagai data pendukung atau turunan.

Materi Modul 13
Pembahasan pada modul ini menitikberatkan pada prosedur operasional fungsional dalam mengelola hubungan antar-elemen pada struktur Multi Linked List (MLL):

1. Insert Anak dan Induk Prosedur penyisipan Induk adalah langkah untuk menambahkan node utama ke dalam sistem yang nantinya akan berperan sebagai titik acuan bagi elemen-elemen di bawahnya. Sementara itu, penyisipan Anak merupakan mekanisme penambahan node turunan ke dalam list yang dikaitkan pada induk yang spesifik, di mana proses ini biasanya dieksekusi dengan meletakkan node anak tersebut langsung setelah posisi induknya melalui metode insertAfter.

2. Delete Anak dan Induk Prosedur penghapusan Induk adalah tindakan mengeliminasi elemen utama dari rangkaian struktur data, yang secara otomatis memutus keterhubungan node tersebut dari daftar keseluruhan. Di sisi lain, penghapusan Anak adalah mekanisme untuk membuang node turunan tertentu dari daftar berdasarkan relasinya dengan induk, namun proses ini tetap mempertahankan keberadaan node induk yang bersangkutan di dalam sistem.
...
```
Program ini menggunakan struktur Multi Linked List yang menggabungkan dua tingkat data: Induk (Parent) yang menyimpan kategori makanan dan Anak (Child) yang menyimpan detail menu makanan. Setiap elemen induk memiliki "kantong" sendiri (berupa listAnak) untuk menampung elemen-elemen anaknya. Keduanya diimplementasikan menggunakan Doubly Linked List, sehingga setiap data memiliki penunjuk ke elemen sebelumnya (prev) dan sesudahnya (next), memudahkan navigasi data secara bolak-balik.
## Unguided
...
```
### Output soal 2 :
![Screenshot Output 2](https://github.com/Tioarmani/Struktur-Data-Assesment/blob/56666b050353762285e3156f37054b2c7a587650/MODUL%2013/foto%20output/Screenshot%202025-12-30%20200937.png)

Program ini merupakan implementasi struktur data hierarkis menggunakan Multi Doubly Linked List yang memungkinkan setiap elemen induk memiliki daftar elemen anak sendiri, sehingga memudahkan pengelolaan data yang memiliki hubungan relasional antara kategori utama dan sub-kategorinya secara dinamis.
...
```
### Output soal 3 :
![Screenshot Output 2](https://github.com/Tioarmani/Struktur-Data-Assesment/blob/56666b050353762285e3156f37054b2c7a587650/MODUL%2013/foto%20output/Screenshot%202025-12-30%20201019.png)

Program ini mengimplementasikan Circular Single Linked List, sebuah variasi dari linked list di mana elemen terakhir tidak menunjuk ke NULL, melainkan kembali menunjuk ke elemen pertama (First). Hal ini menciptakan sebuah lingkaran atau siklus tertutup. Data yang disimpan dalam setiap elemen (node) adalah informasi mahasiswa yang terdiri dari Nama, NIM, Jenis Kelamin, dan IPK.


### Kesimpulan
Ketiga implementasi tersebut menunjukkan bahwa struktur data Multi Linked List dan Circular List memungkinkan pengelolaan data yang sangat fleksibel, baik untuk membangun hubungan hierarkis antara induk dan anak maupun untuk menjamin kontinuitas akses data melalui mekanisme penunjuk yang melingkar.
